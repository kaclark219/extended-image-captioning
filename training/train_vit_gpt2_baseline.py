...
def parse_args():
    ...
    parser.add_argument("--model_id", default="nlpconnect/vit-gpt2-image-captioning")
    parser.add_argument("--output_dir", default="checkpoints/vit-gpt2-baseline")
...
def main():
    ...
    image_processor = ViTImageProcessor.from_pretrained(args.model_id)
    ...
    def build_batch_inputs(images, captions, target_device):
        """Build batch inputs by processing images and tokenizing captions."""
        pixel_values = image_processor(images=images, return_tensors="pt").pixel_values.to(target_device)
        ...
        labels = masked_labels(tokenized.input_ids.to(target_device), tokenizer.pad_token_id)
